...
- **URLs in scope:** 23 unique Dynatrace doc citations across `domain-knowledge.md` (8 citations), the playbook files in `memory/long-term/playbooks/` (16 citations after the 2026-05-20 cleanup of the broken `service-level-objective-basics` URL), and `terminology.md` (8 citations — 7 URLs overlap with `domain-knowledge.md`, so no new unique URLs added)
...
### Playbook citations (`memory/long-term/playbooks/*.md`)
