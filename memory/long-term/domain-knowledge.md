...
**Citation rule.** Every fact pulled from these sources lands in the phase artifact with its URL and the retrieval date (e.g., *"Source: https://docs.dynatrace.com/… — retrieved 2026-05-12"*). Dynatrace documentation changes; the date matters.
