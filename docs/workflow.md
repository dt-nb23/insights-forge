...
2. **Draft the plan** against that set — investigation actions with exit criteria, recommended actions, decision asks, and risks paired with their mitigations. A one-screen direction check — headline, wave structure, candidate action titles — is confirmed with you before the full draft is built.
